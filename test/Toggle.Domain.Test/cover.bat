...
SET opencover=%HOME%\.nuget\packages\OpenCover\4.6.519\tools\OpenCover.Console.exe
SET reportgenerator=%HOME%\.nuget\packages\ReportGenerator\2.5.11\tools\ReportGenerator.exe

SET targetargs="test"  
SET filter="+[Toggle.Domain]*"
